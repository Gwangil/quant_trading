...
CORE = {
    ...
    "baskets": {"count": 4, "slices": 6, "min_days_between_opens": 3, "min_budget_frac": 0.25, "budget_mode": "equity"},
    "entry": {"vol_window": 20, "dip_vol_mult": 0.25, "min_dip_pct": 0.0, "max_dip_pct": 0.06,
              "first_slice_dip_pct": 0.0, "max_slice_mult": 3.0, "target_vol": 0.045},
    "exit": {"lot_tp_vol_mult": 1.0, "min_lot_tp_pct": 0.03, "max_lot_tp_pct": 0.15, "upday_sell_frac": 0.1,
    ...
    "regime": {"enabled": True, "ma_window": 200, "ma_band": 0.0, "bear_max_baskets": 1, "bear_slice_mult": 0.5,
               "bear_liquidate": True, "cooldown_after_sl_days": 20, "breaker_dd": None, "breaker_resume_sma": 200},
